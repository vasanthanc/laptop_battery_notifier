...
class LinuxBatteryNotifier(object):
    ...
    def battery_essential(self):
        self.read_last_battery_information_form_program_location()
        self.get_battery_related_information_and_write_to_a_file()
        timer = Timer(30, self.battery_essential)
        timer.start()
